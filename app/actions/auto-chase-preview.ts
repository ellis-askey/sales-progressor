...
// Escape + wrap an agent-edited body into a minimal email frame — mirrors what
// the send does (edited free text is sent as-is, not the branded shell).
function wrapEditedBody(text: string): string {
