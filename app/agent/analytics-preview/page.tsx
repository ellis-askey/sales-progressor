...
function periodHref(p: string, userId?: string) {
  ...
  return `/agent/analytics-preview${qs ? `?${qs}` : ""}`;
}
    ...
    return (
      <div className="agent-glass" style={{ padding: "18px 22px" }}>
        ...
        <p style={{
          ...
          color: color ?? "var(--agent-text-primary)",
        ...
        {sub && (
          <p style={{ margin: "4px 0 0", fontSize: 11, color: "var(--agent-text-muted)" }}>{sub}</p>
        )}
      </div>
    );
  }
    ...
    <div style={{ display: "flex", flexDirection: "column", minHeight: "100vh" }}>
      ...
      >
        <div aria-hidden="true" style={{
          ...
          background: "radial-gradient(circle, rgba(var(--agent-coral-base-rgb),0.11) 0%, transparent 70%)",
        }} />
        <div style={{ position: "relative" }}>
          <p className="agent-eyebrow" style={{ marginBottom: 14 }}>Analytics · Preview</p>
          <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 16 }}>
            <div>
              <h1 style={{
                margin: 0, fontSize: "var(--agent-text-h2)",
            ...
            {isDirector && team.length > 0 && (
              <AnalyticsFilterClient
                ...
                basePath="/agent/analytics-preview"
              />
            )}
          </div>
        </div>
      ...
      <div style={{ padding: "20px 32px", display: "flex", flexDirection: "column", gap: 18 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12 }}>
          <div className="agent-glass" style={{ padding: "18px 22px" }}>
            ...
            <p style={{ margin: 0, fontSize: 24, fontWeight: 700, color: "var(--agent-text-primary)", letterSpacing: "-0.02em" }}>
          ...
          <div className="agent-glass" style={{ padding: "18px 22px" }}>
            ...
            <p style={{ margin: 0, fontSize: 24, fontWeight: 700, color: "var(--agent-success)", letterSpacing: "-0.02em" }}>
          ...
          <div className="agent-glass" style={{ padding: "18px 22px" }}>
            ...
            {noFeeCount > 0 && (
              <p style={{ margin: "4px 0 0", fontSize: 11, color: "var(--agent-text-muted)" }}>
          ...
          <div className="agent-glass" style={{ padding: "18px 22px" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }}>
              ...
              <div style={{ display: "flex", gap: 12 }}>
                {[
                  { label: "Created",   color: "var(--agent-coral)" },
                  { label: "Exchanged", color: "var(--agent-warning)" },
                ].map(({ label, color }) => (
          ...
          >
            ...
            {solicitorStats.map((s, i) => {
              ...
              return (
                ...
                >
                  <p style={{ margin: 0, fontSize: 13, fontWeight: 500, color: "var(--agent-text-primary)", flex: 1, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                    {s.firmName}
                  </p>
                  <span style={{ fontSize: 12, color: "var(--agent-text-muted)", flexShrink: 0 }}>
                    {s.exchangeCount} {s.exchangeCount === 1 ? "exchange" : "exchanges"}
                  </span>
                  <span style={{ fontSize: 12, fontWeight: 600, color: "var(--agent-text-primary)", flexShrink: 0, minWidth: 64, textAlign: "right" }}>
                    {s.avgDaysToExchange} days
                  </span>
                  <span style={{
        ...
        {referredTxs.length > 0 && (
          <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
            <p className="agent-eyebrow" style={{ paddingLeft: 2 }}>
              Referral income — {periodLabel.toLowerCase()}
            </p>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
              <div className="agent-glass" style={{ padding: "18px 22px" }}>
                ...
                <p style={{ margin: 0, fontSize: 24, fontWeight: 700, color: "var(--agent-text-primary)", letterSpacing: "-0.02em" }}>
                  {inPipelinePence > 0 ? fmtGBP(inPipelinePence) : "—"}
                </p>
                <p style={{ margin: "4px 0 0", fontSize: 11, color: "var(--agent-text-muted)" }}>
              ...
              <div className="agent-glass" style={{ padding: "18px 22px" }}>
                ...
                <p style={{ margin: 0, fontSize: 24, fontWeight: 700, color: "var(--agent-warning)", letterSpacing: "-0.02em" }}>
                  {duePence > 0 ? fmtGBP(duePence) : "—"}
                </p>
                <p style={{ margin: "4px 0 0", fontSize: 11, color: "var(--agent-text-muted)" }}>
        ...
        {noFeeTransactions.length > 0 && (
          ...
          >
            <div style={{ padding: "14px 20px", borderBottom: "0.5px solid var(--agent-border-subtle)" }}>
              ...
              <p style={{ margin: "2px 0 0", fontSize: 11, color: "var(--agent-text-muted)" }}>
                Open each file and set the agent fee in the sidebar.
              </p>
            </div>
            {noFeeTransactions.map((t, i) => (
              ...
              >
                ...
                <Link
                  ...
                  style={{ fontSize: 12, fontWeight: 600, color: "var(--agent-coral-deep)", textDecoration: "none", flexShrink: 0 }}
                >
                  Set fee →
                </Link>
              </div>
