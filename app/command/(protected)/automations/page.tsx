  ...
  return (
    <div className="space-y-6">
      <div className="glass-card rounded-2xl px-6 py-8 max-w-lg">
        <p className="text-sm font-semibold text-white/70 mb-2">Automation Brain not yet built</p>
        ...
        <div className="mt-4 space-y-1.5">
          <p className="text-[11px] text-white/25 font-semibold uppercase tracking-wide">Pending before build</p>
          {[
