...
// Drafts & images (docs/active/content-brand/SPEC.md, Phase 1.5). The original
// content drafter, re-homed from /command/content (now the Overview) so the
// section has a proper landing. Behaviour unchanged.
  ...
  if (qaSampleCount === 0) {
    return (
      <div className="space-y-8">
        <h1 className="text-2xl font-semibold text-neutral-100">Drafts &amp; images</h1>
    ...
    <div className="space-y-10">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Link href="/command/content" className="text-xs text-neutral-500 transition-colors hover:text-neutral-300">
            ← Content
          </Link>
          <h1 className="text-2xl font-semibold text-neutral-100">Drafts &amp; images</h1>
        </div>
