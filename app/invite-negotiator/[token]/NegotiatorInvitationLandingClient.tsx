...
import type { ValidatedNegotiatorInvitation } from "@/lib/auth/validate-negotiator-invitation-token";

interface Props {
  token: string;
  invitation: ValidatedNegotiatorInvitation;
...
function BrandMark() {
  return (
    <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect width="44" height="44" rx="12" fill="url(#bm-grad-nilc)" />
      <defs>
        <linearGradient id="bm-grad-nilc" x1="0" y1="0" x2="44" y2="44" gradientUnits="userSpaceOnUse">
...
export function NegotiatorInvitationLandingClient({ token, invitation, existingEmail, mismatch }: Props) {
  const acceptUrl = `/invite-negotiator/${token}/accept`;
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "2rem 1rem" }}>
      ...
      <style>{`
        ...
        .nilc-oauth:active:not(:disabled) { transform: scale(0.98); }
      `}</style>
      ...
      <div style={{ position: "relative", zIndex: 10, width: "100%", maxWidth: "400px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "1.75rem" }}>
          ...
          <p style={{ margin: "0.4rem 0 0", fontSize: "13px", color: "#7A4A2E", opacity: 0.85, lineHeight: 1.5 }}>
            ...
            <strong style={{ color: "#3D1F0E" }}>{invitation.agencyName}</strong> on Sales Progressor as a negotiator.
          </p>
        </div>
        ...
        <div style={{
          ...
          {mismatch && (
            <div style={{
              ...
              <strong>{invitation.negotiatorEmail}</strong>.
            </div>
          )}

          {existingEmail && existingEmail.toLowerCase() !== invitation.negotiatorEmail.toLowerCase() ? (
            <div style={{ display: "flex", flexDirection: "column", gap: "1rem", textAlign: "center" }}>
              ...
              <button
                onClick={() => signOut({ callbackUrl: `/invite-negotiator/${token}` })}
                style={{
                  width: "100%",
                  padding: "12px",
                  borderRadius: "8px",
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
              ...
              <a
                href={`/invite-negotiator/${token}/password`}
                style={{
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
              ...
              <p style={{ margin: "4px 0 0", fontSize: "11px", color: "rgba(61,31,14,0.45)", textAlign: "center" }}>
                Invitation sent to {invitation.negotiatorEmail}
              </p>
            </div>
          )}
        </div>
