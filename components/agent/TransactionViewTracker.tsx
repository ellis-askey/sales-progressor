...
export function TransactionViewTracker({ transactionId, propertyAddress }: { transactionId: string; propertyAddress: string }) {
  useEffect(() => {
    analytics.track(ANALYTICS_EVENTS.TRANSACTION_VIEWED, { transactionId });
    trackView(transactionId, propertyAddress);
