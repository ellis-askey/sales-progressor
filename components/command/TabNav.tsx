...
const TABS = [
  ...
  { href: "/command/growth",        label: "Growth",       soon: true },
  { href: "/command/activation",    label: "Activation",   soon: true },
  { href: "/command/retention",     label: "Retention",    soon: true },
  { href: "/command/activity",      label: "Activity",     soon: true },
