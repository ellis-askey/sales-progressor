    ...
    <div className="mb-3">
      ...
      {items.length > 5 && (
        <button
          ...
          className="text-xs agent-link-primary mt-1"
        >
          ...
          {!delta ? (
            <>
              <button
                ...
                disabled={loading}
                className="flex-1 py-2.5 rounded-xl agent-btn-color-primary text-sm font-semibold transition-colors disabled:opacity-40"
              >
