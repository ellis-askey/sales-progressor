    ...
    return (
      <div className="flex items-center gap-3 px-4 py-3">
        ...
        <div>
          ...
          <p className="text-xs text-emerald-500">All milestones complete</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="flex items-center gap-3 px-4 py-3">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-xs font-medium text-gray-400">{label}</p>
          <p className="text-xs font-medium text-gray-700 truncate">{milestone.name}</p>
        </div>
        <button
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm mx-4 overflow-hidden">
            <div className="px-5 py-4 border-b border-gray-100">
              <p className="text-sm font-semibold text-gray-800">Also completing</p>
              <p className="text-xs text-gray-400 mt-0.5">These steps are implied by this milestone</p>
            </div>
            <ul className="px-5 py-3 space-y-1.5 max-h-48 overflow-y-auto">
              ...
              <li className="flex items-center gap-2 text-xs font-semibold text-gray-800">
            ...
            <div className="px-5 py-4 border-t border-gray-100 flex gap-2">
              <button
                ...
                className="flex-1 py-2 text-xs font-semibold bg-blue-500 hover:bg-blue-600 text-white rounded-lg transition-colors"
              >
                Confirm all
              </button>
              <button
                onClick={() => setShowImplied(false)}
                className="flex-1 py-2 text-xs text-gray-500 hover:text-gray-700 rounded-lg hover:bg-gray-50 transition-colors"
              >
                Cancel
              </button>
            </div>
    ...
    <div className="bg-white rounded-xl border border-[#e4e9f0] overflow-hidden"
      ...
      <div className="px-4 py-2.5 border-b border-[#f0f4f8]">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-xs font-semibold text-gray-600">Next steps</h3>
        </div>
      </div>
