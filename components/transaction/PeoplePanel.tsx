...
export function PeoplePanel({
  ...
  // Slide the highlight onto the active tab; re-measures on switch so it tracks
  // the different-width labels exactly.
  ...
  return (
    <GlassCard glassId="overview-people" label="Overview · People" defaultVariant="v05" style={{ borderRadius: 12, overflow: "hidden" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", padding: "12px 16px", borderBottom: "0.5px solid var(--agent-border-default)" }}>
        <div style={{ position: "relative", display: "inline-flex", padding: 3, borderRadius: 10, gap: 2, background: "rgba(15,23,42,0.05)", border: "0.5px solid var(--agent-border-default)" }}>
