      ...
      <div className="px-5 py-4">
        ...
        <div className="mb-4">
          <div className="flex items-center justify-between mb-1.5">
            ...
            <p className={`text-xs font-semibold ${level === "no_data" ? "text-slate-900/30" : "text-slate-900/70"}`}>{score} / 100</p>
          </div>
        ...
        {level === "no_data" ? (
          <p className="text-xs text-slate-900/30 italic">Risk factors will appear as the file progresses.</p>
        ) : (
          <>
            {/* Active risk factors */}
            {triggered.length > 0 && (
