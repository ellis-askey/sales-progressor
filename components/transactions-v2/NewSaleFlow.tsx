...
function populateFormFromDraft(draft: DraftEntry): FormFields {
  ...
  return {
    ...
    broker: draft.broker,
    brokerReferralFee: draft.brokerReferralFee,
    purchaserBrokerReferral: draft.purchaserBrokerReferral,
    onwardBroker: draft.onwardBroker,
    onwardBrokerReferralFee: draft.onwardBrokerReferralFee,
    onwardBrokerReferral: draft.onwardBrokerReferral,
    notes: draft.notes ?? "",
...
function buildDraftInput(fields: FormFields, mosData: ExtractedMemoData | null, draftId?: string) {
  ...
  return {
    ...
    purchaserBrokerReferral: fields.broker ? fields.purchaserBrokerReferral : false,
    onwardBrokerFirmId: fields.onwardBroker?.firmId ?? null,
    onwardBrokerContactId: fields.onwardBroker?.contactId ?? null,
    onwardBrokerReferralFee: fields.onwardBroker ? fields.onwardBrokerReferralFee : null,
    onwardBrokerReferral: fields.onwardBroker ? fields.onwardBrokerReferral : false,
  ...
  function upsertDraftInList(id: string, address: string, extra: Partial<DraftEntry> = {}) {
    setDrafts((prev) => {
      ...
      return [{
        ...
        brokerReferralFee: extra.brokerReferralFee ?? null,
        purchaserBrokerReferral: extra.purchaserBrokerReferral ?? false,
        onwardBroker: extra.onwardBroker ?? null,
        onwardBrokerReferralFee: extra.onwardBrokerReferralFee ?? null,
        onwardBrokerReferral: extra.onwardBrokerReferral ?? false,
