...
Generated from `lib/email-skeletons/pm6.ts` by `scripts/render-email-snapshot.ts`. Every recipient × shape (× route × direction for bilateral) combination assembled and rendered as it would land in the inbox.
...
**Subject:** PM6 complete: Lender valuation booked — 22 Example Road, London SW1A 1AA
...
Lender valuation booked for Tuesday 3 June.
