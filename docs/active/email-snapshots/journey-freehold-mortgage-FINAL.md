# Journey: Freehold × Mortgage

Final rewritten email matrix for this journey shape. Differs from freehold-cash_buyer ONLY where mortgage content applies. Where this file is silent on a milestone, the freehold-cash_buyer-FINAL.md copy applies verbatim.

**Voice:** Agency white-labelled "we". Transactional notification style. "Hi [name]" opener, no sign-off, ends at portal link.
**Shape:** Freehold (no TA7, no management pack, Phase 7 suppressed). Mortgage (Phase 5 fires: PM5/PM6/PM11; mortgage funding language at PM25/PM26; deposit transfer fires at PM24; no related sale / no chain). See `SHAPE-NOTES.md`.
...
### PM3 — Buyer has completed ID and AML checks (purchaser delta)
...
### PM4 — Buyer has paid money on account (purchaser delta)
...
## Phase 5 — Mortgage (fires on this journey)
...
The valuation is scheduled, and the surveyor will visit the property to carry out the inspection. They'll be in touch directly to arrange access if they haven't already. It's a brief visit, typically 30 to 60 minutes.
...
## Phase 6 — Draft contract pack (PM7 purchaser deltas)

VM7 same as freehold-cash_buyer. PM7 purchaser deltas:
...
**PM7 — Natural × Internal:** mortgage variant adds "Keep your mortgage application and your survey progressing in parallel while that's in flight." in the closing paragraph.

**PM7 — Inverse × Portal / Internal:** mortgage variant adds "Keep your mortgage application and your survey progressing in parallel." in the closing paragraph.

---

## Phase 8 — Searches (PM13 purchaser delta)
...
## Phase 9 — Survey (PM9 purchaser delta)
...
## Phase 13 — Deposit (PM24 purchaser delta)
...
The buyer's deposit is now with their solicitor, ready to be released on exchange. That's one of the strongest commitment signals in the whole process. With their mortgage offer already in place and the deposit now committed, the buyer's funding is fully lined up.
...
### PM25 — Vendor delta (mortgage wording)
...
The buyer's solicitor has formally confirmed everything on their side is in place: contracts signed, conveyancing complete, mortgage offer in, deposit transferred and held ready. Once both sides have formally confirmed, exchange follows.

→ View your portal
```

### PM25 — Purchaser delta
...
### PM26 — Purchaser delta (mortgage wording)
...
## Phase 16 — Completion (PM27 purchaser delta)
...
**End of journey: Freehold × Mortgage.**
