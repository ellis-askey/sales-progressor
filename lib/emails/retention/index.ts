...
export function buildActivationDay1(vars: TemplateVars): RetentionEmailResult {
  ...
  const text = [
    `Hi ${firstName},`,
    ``,
    `Your account is ready. Add your first sale to start using the platform. Self-progress is free, and if you'd like us to run a sale for you, your first outsourced one is on us.`,
    ``,
    `Add a sale: ${ctaUrl}`,
    ``,
  ...
  const bodyHtml = [
    ...
    `<p style="margin:0 0 16px;color:#374151;font-size:15px;line-height:1.6">Your account is ready. Add your first sale to start using the platform. Self-progress is free, and if you'd like us to run a sale for you, your first outsourced one is on us.</p>`,
...
export function buildStuckDay3(vars: TemplateVars): RetentionEmailResult {
  ...
  const text = [
    `Hi ${firstName},`,
    ``,
    `You've added ${address} to Sales Progressor but haven't confirmed any milestones yet. We start moving as soon as you tick off the first few steps.`,
    ``,
  ...
  const bodyHtml = [
    `<p style="margin:0 0 16px;color:#374151;font-size:15px;line-height:1.6">Hi ${firstName},</p>`,
    `<p style="margin:0 0 16px;color:#374151;font-size:15px;line-height:1.6">You've added ${address} to Sales Progressor but haven't confirmed any milestones yet. We start moving as soon as you tick off the first few steps.</p>`,
