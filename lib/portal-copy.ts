  ...
  VM1: {
    ...
    emailCopy: {
      vendor: {
        ...
        opening: "Your solicitor is now instructed and can start getting things underway.",
        ...
        whatNext: "Your solicitor will prepare the contract pack and, if the property is leasehold, request the management pack from your freeholder or managing agent. This typically takes a few weeks. We'll keep you updated as things move on.",
        action: "View your portal",
      },
      purchaser: {
        subject: "The seller has instructed their solicitor: {address}",
        heroLabel: "Seller's solicitor instructed",
        opening: "A little update on where things are with your purchase.",
        ...
        whatNext: "There's nothing you need to do for this step at the moment. The seller's solicitor will prepare the contract pack and send it to your solicitor in the coming weeks. We'll let you know when that happens.",
        action: "View your portal",
      },
      progressor: {
  ...
  VM2: {
    ...
    emailCopy: {
      vendor: {
        ...
        opening: "The legal process is now getting underway.",
        ...
        whatNext: "Your solicitor will now begin preparing the contract pack. If you still have their welcome paperwork to return, getting that back to them when you can will help them keep things moving.",
        action: "View your portal",
      },
      purchaser: {
        subject: "Memorandum of sale issued: {address}",
        ...
        whatNext: "If you still have your solicitor's welcome pack or ID checks to complete, it's worth getting those back to them when you can so they can get fully underway. If you're buying with a mortgage, this is also a good time to keep an eye on your application with your broker or lender.",
        action: "View your portal",
      },
      progressor: {
  ...
  VM3: {
    ...
    emailCopy: {
      purchaser: {
        ...
        whatNext: "There's nothing you need to do for this step at the moment. The seller will return the forms to their solicitor in due course.",
        action: "View your portal",
      },
      vendor: {
        subject: "Welcome pack received from your solicitor: {address}",
        heroLabel: "Welcome pack received",
        opening: "Your solicitor has now sent their welcome pack.",
        ...
        whatNext: "When you have a chance, work through the forms and send them back to your solicitor. Getting them returned in the next few days, where possible, will help your solicitor get properly underway.",
        action: "View your portal",
      },
      progressor: {
  ...
  VM4: {
    ...
    emailCopy: {
      purchaser: {
        ...
        whatNext: "There's nothing you need to do for this step at the moment. It means another of the early legal checks on the seller's side is now out of the way.",
        action: "View your portal",
      },
      vendor: {
        subject: "ID checks complete: {address}",
        heroLabel: "ID & AML checks done",
        opening: "Your ID checks are now complete.",
        ...
        whatNext: "Your solicitor can now continue preparing the contract pack. If your property information forms are still with you, returning them when you can will help avoid an unnecessary hold-up at this early stage.",
        action: "View your portal",
      },
      progressor: {
  ...
  VM5: {
    ...
    emailCopy: {
      purchaser: {
        ...
        whatNext: "There's nothing you need to do for this step at the moment. The seller will complete and return these to their solicitor in the coming days.",
        action: "View your portal",
      },
      vendor: {
        subject: "Property information forms received: {address}",
        heroLabel: "Property forms to complete",
        opening: "Your solicitor has now sent over the property information forms for you to complete.",
        whatHappened: "Your solicitor has sent you the property information forms (TA6 and TA10), which ask for some information about the property and what's included in the sale. They'll form part of the information provided to the buyer's solicitor as the legal work progresses.",
        whatNext: "When you get a chance, work through the forms as fully as you can and send them back to your solicitor. Some of the questions can be a little specific, so if there's anything you're unsure about, your solicitor will be best placed to help rather than you having to guess.",
        action: "View your portal",
      },
      progressor: {
  ...
  VM6: {
    ...
    emailCopy: {
      vendor: {
        ...
        opening: "Your completed property forms are now back with your solicitor.",
      ...
      purchaser: {
        ...
        heroLabel: "Property forms returned",
        opening: "Another part of the legal work is now in place on your purchase.",
        ...
        whatNext: "There's nothing you need to do for this step at the moment. The seller's solicitor will now finalise the contract pack and send it across.",
        action: "View your portal",
      },
      progressor: {
  ...
  VM7: {
    ...
    emailCopy: {
      vendor: {
        ...
        opening: "Your solicitor has now sent the contract pack to the buyer's solicitor.",
        whatHappened: "Your solicitor has sent the draft contract pack to the buyer's solicitor. This is the bundle of documents that forms the main legal paperwork for the sale: the contract itself, your property information forms, title documents, and any relevant certificates.",
  ...
  VM8: {
    ...
    emailCopy: {
      purchaser: {
        ...
        whatNext: "Management packs sometimes take a few weeks to come back, but this is now in motion. There's nothing you need to do for this step at the moment.",
        action: "View your portal",
      },
      vendor: {
        subject: "Management pack requested from your freeholder: {address}",
        heroLabel: "Management pack requested",
        opening: "The management pack has now been requested.",
  ...
  VM9: {
    ...
    emailCopy: {
      vendor: {
        ...
        opening: "The management pack has now arrived.",
      ...
      purchaser: {
        ...
        heroLabel: "Management pack received",
        opening: "The management pack has now been received.",
  ...
  VM10: {
    ...
    emailCopy: {
      ...
      vendor: {
        ...
        opening: "The first enquiries have now come in from the buyer's solicitor.",
  ...
  VM16: {
    ...
    emailCopy: {
      purchaser: {
        ...
        opening: "A little update on where things are with your purchase.",
        whatHappened: "The seller has received their contract documents to review and sign. This is an important step. This brings things another step closer to exchange.",
        whatNext: "There's nothing you need to do for this step at the moment. We'll let you know once the seller has signed and returned their contract.",
        action: "View your portal",
      },
      vendor: {
        subject: "Your contract is ready to sign: {address}",
        heroLabel: "Contract ready to sign",
        opening: "Your contract documents are now ready for you to review and sign.",
        ...
        whatNext: "Take a little time to read through the contract and check that the purchase price, proposed completion date and fixtures and fittings are as expected. Your solicitor will talk you through anything you are unsure about and explain what signing means. Once you're happy with everything, you can sign and return the documents to them.",
        action: "View your portal",
      },
      progressor: {
  ...
  VM17: {
    ...
    emailCopy: {
      purchaser: {
        ...
        opening: "The seller has now signed and returned their contract.",
      ...
      vendor: {
        ...
        opening: "Your signed contract is now back with your solicitor.",
  ...
  VM18: {
    ...
    emailCopy: {
      vendor: {
        ...
        opening: "Your solicitor has confirmed they are ready to exchange.",
        ...
        whatNext: "We're now checking that everything is also in place on the buyer's side. Once both solicitors are ready, exchange can sometimes follow quite quickly, so it's worth keeping an eye on your phone in case anything needs confirming.",
        action: "View your portal",
      },
      purchaser: {
        subject: "The seller's solicitor is ready to exchange: {address}",
        heroLabel: "Seller ready to exchange",
        opening: "The seller's solicitor has confirmed they are ready to exchange.",
        ...
        whatNext: "If you haven't already, it's worth checking that your solicitor has both your signed contract and the deposit as cleared funds, as they'll need these before exchange. We'll be in touch as soon as exchange is confirmed.",
        action: "View your portal",
      },
      progressor: {
  ...
  VM19: {
    ...
    emailCopy: {
      vendor: {
        ...
        whatNext: "Between now and completion, you can focus on getting the property ready to hand over at the agreed time. Your solicitor will take care of the legal transfer of funds and will confirm with you once completion has taken place.",
        action: "View your portal",
      },
  ...
  PM1: {
    ...
    emailCopy: {
      purchaser: {
        ...
        whatNext: "If you haven't already, it's worth working through your solicitor's welcome pack and ID checks when you get a chance, as they'll need these before they can get fully underway. We'll keep you updated as things move on.",
        action: "View your portal",
      },
      vendor: {
        ...
        whatNext: "There's nothing you need to do for this step at the moment. We'll keep you updated as both sides progress.",
        action: "View your portal",
      },
      progressor: {
  ...
  PM3: {
    ...
    emailCopy: {
      vendor: {
        ...
        whatNext: "There's nothing you need to do for this step at the moment. It means another of the early legal checks on the buyer's side is now out of the way.",
        action: "View your portal",
      },
      purchaser: {
        subject: "ID checks complete: {address}",
        ...
        whatNext: "Your solicitor is now able to get properly underway. If they are still waiting for your payment on account, it's worth arranging this when you can, as they'll need the funds before they can order the searches.",
        action: "View your portal",
      },
      progressor: {
  ...
  PM4: {
    ...
    emailCopy: {
      vendor: {
        ...
        opening: "The buyer has now put the initial funds in place with their solicitor.",
        whatHappened: "The buyer has transferred funds to their solicitor for searches and disbursements. It means their solicitor now has the funds needed to order searches and cover the initial legal costs.",
      ...
      purchaser: {
        ...
        opening: "Your solicitor has now received your payment on account.",
  ...
  PM5: {
    ...
    emailCopy: {
      ...
      purchaser: {
        ...
        heroLabel: "Mortgage application submitted",
        opening: "Your mortgage application has now been submitted.",
  ...
  PM7: {
    ...
    emailCopy: {
      purchaser: {
        ...
        heroLabel: "Contract pack received",
        opening: "The contract pack is now with your solicitor.",
        whatHappened: "Your solicitor has received the contract pack from the seller's solicitor. This is the bundle of documents that forms the main legal paperwork for the purchase: the draft contract, title documents, property information forms, and any relevant certificates. Your solicitor will now review everything carefully.",
        whatNext: "Your solicitor will work through the contract pack and raise enquiries. If you haven't already ordered searches, it's worth checking that this is in hand. Your solicitor needs your payment on account before they can do so. In parallel, keep your mortgage application and survey progressing.",
        action: "View your portal",
      },
      vendor: {
        subject: "Your contract pack has arrived with the buyer's solicitor: {address}",
        heroLabel: "Contract pack received",
        opening: "Another part of the legal work is now in place on your sale.",
  ...
  PM8: {
    ...
    emailCopy: {
      vendor: {
        ...
        whatNext: "There's nothing you need to do for this step at the moment. We'll keep you updated as the next pieces fall into place.",
        action: "View your portal",
      },
      purchaser: {
  ...
  PM9: {
    ...
    emailCopy: {
      vendor: {
        ...
        whatHappened: "Once the surveyor has a date in mind, access to the property will be arranged in the usual way, normally through the estate agent. There's nothing you need to do for this step at the moment. If the survey raises anything the buyer wishes to investigate further, this may be raised with your solicitor as an enquiry. If anything is needed from you, we'll be in touch.",
        whatNext: null,
        action: "View your portal",
      },
      purchaser: {
  ...
  PM10: {
    ...
    emailCopy: {
      vendor: {
        ...
        whatHappened: "There's nothing you need to do for this step at the moment. No news is generally good news when it comes to survey reports, so unless the buyer raises anything, the sale will simply continue progressing as normal.",
  ...
  PM11: {
    ...
    emailCopy: {
      purchaser: {
        ...
        opening: "Your mortgage offer has now been issued.",
        ...
        whatNext: "It's worth taking a moment to check the offer carefully. Confirm the loan amount, rate, and term match what you agreed with your broker or lender. If anything doesn't look as expected, speak with your broker, lender or solicitor so they can check it with you. Your solicitor will review the conditions and let you know if anything needs addressing.",
        action: "View your portal",
      },
      vendor: {
        ...
        whatNext: "There's nothing you need to do for this step at the moment. The transaction is moving in the right direction on the buyer's side.",
        action: "View your portal",
      },
      vendorAgent: {
  ...
  PM12: {
    ...
    emailCopy: {
      vendor: {
        ...
        whatNext: "There's nothing you need to do for this step at the moment.",
        action: "View your portal",
      },
      purchaser: {
        subject: "Management pack received: {address}",
  ...
  PM13: {
    ...
    emailCopy: {
      vendor: {
        ...
        whatNext: "There's nothing you need to do for this step at the moment. Most searches come back without issue. We'll let you know if anything needs attention.",
        action: "View your portal",
      },
      purchaser: {
        subject: "Search results back: {address}",
        heroLabel: "Search results received",
        opening: "Your search results are now back with your solicitor.",
  ...
  PM14: {
    ...
    emailCopy: {
      ...
      purchaser: {
        ...
        whatHappened: "Your solicitor has raised their first round of enquiries with the seller's solicitor: questions about the property, the title, and the documents in the contract pack. This is a normal part of the legal process.",
  ...
  PM20: {
    ...
    emailCopy: {
      ...
      purchaser: {
        ...
        heroLabel: "All enquiries satisfied",
        opening: "A good step forward on your purchase.",
  ...
  PM22: {
    ...
    emailCopy: {
      vendor: {
        ...
        opening: "A little update on where things are with your sale.",
        whatHappened: "The buyer's solicitor has issued the contract documents to the buyer for review and signature. This brings things another step closer to exchange.",
        whatNext: "Once the buyer signs and returns the contract, they will be another step closer to being ready to exchange.",
        action: "View your portal",
      },
      purchaser: {
        subject: "Your contract is ready to sign: {address}",
  ...
  PM23: {
    ...
    emailCopy: {
      ...
      purchaser: {
        ...
        whatNext: "If your deposit isn't already with your solicitor, they'll need to receive it as cleared funds before exchange can take place. They'll let you know the safest way to arrange the transfer if you haven't done this yet.",
        action: "View your portal",
      },
      vendorAgent: {
        subject: "Buyer has signed and returned their contract: {address}",
  ...
  PM24: {
    ...
    emailCopy: {
      ...
      purchaser: {
        ...
        whatNext: "Everything is now in place on your side. We're coordinating exchange with the seller's solicitor. We'll keep you updated as the final points are lined up for exchange.",
        action: "View your portal",
      },
      progressor: {
  ...
  PM25: {
    ...
    emailCopy: {
      purchaser: {
        ...
        whatNext: "We're now coordinating with the seller's solicitor to line up exchange. Once both sides are ready it can sometimes happen quite quickly, so it's worth keeping an eye on your phone in case anything needs confirming.",
        action: "View your portal",
      },
      vendor: {
        subject: "The buyer's solicitor is ready to exchange: {address}",
        heroLabel: "Buyer ready to exchange",
        opening: "The buyer's solicitor has confirmed they are ready to exchange.",
        ...
        whatNext: "We'll be coordinating the final arrangements with both solicitors. Exchange can sometimes follow quite quickly from here, so it's worth keeping an eye on your phone in case anything needs confirming.",
        action: "View your portal",
      },
      progressor: {
  ...
  PM27: {
    ...
    emailCopy: {
      purchaser: {
        ...
        whatNext: "It's worth keeping your completion statement and transfer documents somewhere safe for your records, as they may be useful in future. Your solicitor will also confirm once your ownership has been registered at HM Land Registry; that part can take a little while to come through.",
        action: "View your portal",
      },
